        ...
        <div class="d-flex w-100 overflow-y-scroll h-100" style="margin-top: 0px">
            <div class="profile-header" style="">
                ...
                @else
                    ...
                    @elseif(\Illuminate\Support\Facades\Auth::user()->isSubscribed($profile))
                    ...
                    @endif
                    <button style="margin-top: 2ch" class="subscribe-button" onclick="location.href='{{route('chat',['to_id'=>$profile->id])}}'">Написать сообщение</button>
                @endif
