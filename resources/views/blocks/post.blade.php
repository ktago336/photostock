        ...
        <div class="post-info d-flex justify-content-between align-items-end">
            ...
            <div class="d-flex">
                <span data-bs-toggle="modal" data-bs-target="#comments-modal" class="likes comment-btn d-flex" data-commentable-id="{{$post->id}}" data-commentable-type="{{\App\Models\Post::class}}">
                    ...
                    <div class="comment-symbol @if(\Illuminate\Support\Facades\Auth::user()->liked()->where('likeable_type',$post::class)->where('likeable_id',$post->id)->first()) red @endif"> <img style="fill: #0077B5; height: 2ch; margin-right: 2ch" src="/svg/comment.svg"></div>
                </span>
